...
const LandingPage = () => {
  ...
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false); // ✅ fixed typo
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          ...
          <button
            ...
            onClick={() => setMobileMenuOpen(!mobileMenuOpen)} // ✅ fixed typo
          >
            {mobileMenuOpen ? (
        ...
        {/* ✅ mobile menu must be inside header */}
        {mobileMenuOpen && (
              ...
              {user ? (
                <div className={landingPageStyles.mobileUserInfo}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      navigate('/dashboard');
                      setMobileMenuOpen(false); // ✅ fixed typo
                    }}
                  >
                    Go to Dashboard
                  </button>
          ...
          <div className={landingPageStyles.heroGrid}>
            <div className={landingPageStyles.heroLeft}>
             ...
             <h1 className={landingPageStyles.heading}>
              <span className={landingPageStyles}>Craft</span>
             ...
             <div className={landingPageStyles.statsContainer}> 
                { [
                                  ...
                                  <div className={landingPageStyles.statItem} key={idx}>
                                    ...
                                    <div className={landingPageStyles.statLabel}>{stat.label}
                                    </div>
                                  </div>
                                ))}
             </div>
