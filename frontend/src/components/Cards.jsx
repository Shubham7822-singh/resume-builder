    ...
    user && (
      <div className={cardStyles.profileCard}>
        ...
        <div className="flex flex-col justify-center">
          ...
          <button
            className="text-sm text-red-600 hover:text-red-700 hover:underline mt-1 transition-all"
...
export const TemplateCard = ({thumnailImg, isSelected, onSelect}) => {
  return (
    <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden
    cursor-pointer transitiona-all duration-500 hover:scale-105 hover:shadow-lg rounded-3xl
    ${
      ...
      {thumnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
              <img src={thumnailImg || '/placeholder.svg'} alt="template Review" className="w-full h-full
              ...
              to-transparent opacity-100 group-hover:opacity-100 transition-opacity duration-300"/>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-violet-100/3 to-transparent opacity-0
              group-hover:opacity-100 transition-opacity duration-300">
              </div>
        </div>
      ) : <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50
      via-violet-600 to bg-fuchsia-50">
          <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to bg-fuchsia-500 rounded-2xl flex
